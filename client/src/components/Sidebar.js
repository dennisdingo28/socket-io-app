  ...
  return (
    <div style={{ width: '250px'}} className="d-flex flex-column">
      <Tab.Container activeKey={activeKey} onSelect={setActiveKey}>
            ...
            <Tab.Content className="border-r overflow-auto flex-grow-1" style={{borderRight:"1px solid #DEE2E6"}}>
            ...
            <div className="p-2 border-top border-right small" style={{borderRight:"1px solid #DEE2E6"}}>
